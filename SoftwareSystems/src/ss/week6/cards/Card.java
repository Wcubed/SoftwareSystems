...
public class Card {
	 ...
	 * @return <code>true</code> if the suit and rank of <code>obj</code> are the
	 *         same as of this Card.
	 */
	@Override
	 ...
	 * 
	 * @param card Card for the comparison.
	 * @return <code>true</code> if the rank of this Card directly precedes the rank
	 *         of <code>card</code>.
	 */
